...
export default function BecomeHostModal({ onClose }: Props) {
  ...
  return (
    <div className="bh-overlay" role="dialog" aria-modal="true" aria-labelledby="bh-title" onClick={(e) => { if (e.target === e.currentTarget) onClose() }}>
      <div className="bh-card">
        <div className="bh-header">
          <h2 className="bh-header__title" id="bh-title">Apply to Become a Host</h2>
          <button type="button" className="bh-header__close" onClick={onClose} aria-label="Close">
            <FiX />
          </button>
        </div>
        ...
        {success ? (
          <div className="bh-success">
            ...
            <button type="button" className="bh-success__btn" onClick={onClose}>Close</button>
          </div>
        ) : (
          <form className="bh-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="bh-actions">
              <button type="button" className="bh-actions__cancel" onClick={onClose} disabled={loading}>
                Cancel
              </button>
